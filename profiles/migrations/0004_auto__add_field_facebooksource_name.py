...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FacebookSource.name'
        db.add_column('profiles_facebooksource', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FacebookSource.name'
        db.delete_column('profiles_facebooksource', 'name')
